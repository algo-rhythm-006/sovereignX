  ...
  return (
    <AuthLayout>
      <section className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden py-safe px-safe xs:px-5">
        <div className="relative z-10 h-[640px] w-[480px] bg-transparent px-12 pt-14 lg:w-[464px] lg:px-10 lg:pt-[54px] md:px-11 xs:h-auto xs:py-8 xs:w-full xs:max-w-sm xs:px-5 border border-white/10 rounded-[20px] xs:rounded-[18px]">
              ...
              {step === "form" && (
                ...
                >
                  ...
                  <form onSubmit={handleFormSubmit} className="mt-7 flex flex-col lg:mt-6 xs:mt-5 w-full" noValidate>
                    ...
                    <label className="mt-4 block text-14 leading-snug tracking-snugger text-grey-60" htmlFor="email">
                        Email
                    </label>
                    <div className="relative mt-0.5 xs:mb-2 w-full">
                    ...
                    <div className="mt-[24px] h-11 xs:mt-4 xs:h-10 w-full group relative rounded-full">
                        <button 
                            ...
                            className={`transition-all duration-300 uppercase font-bold flex items-center justify-center h-11 w-full text-13 text-black -tracking-[0.015em] relative z-10 rounded-full border border-white/60 bg-white px-16 xs:h-10 overflow-hidden shadow-[0_0_15px_rgba(255,255,255,0.3)] ${(!name || !email || !password || isLoading) ? 'opacity-70 cursor-not-allowed' : 'hover:bg-grey-5 group-hover:shadow-[0_0_25px_rgba(255,170,129,0.5)]'}`}
                        >
                            <div
        ...
        <div className="relative z-10 mt-4 flex items-center gap-x-1 text-14 leading-snug tracking-snugger">
          ...
          <a className="text-grey-90 hover:text-white" href="/auth">
            Log in
          </a>
        </div>
